...
export const config = {
  matcher: [
    "/((?!api|auth/callback|auth/login|auth/recovery-prepare|auth/recovery-confirm|_next/static|_next/image|favicon.ico|robots.txt|sitemap.xml|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)",
  ],
};
